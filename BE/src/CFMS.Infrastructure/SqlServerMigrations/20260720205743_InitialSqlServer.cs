        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_users_Role_Valid", "[Role] IN ('Customer', 'SupportStaff', 'DepartmentManager', 'SystemAdmin')");
                    table.CheckConstraint("CK_users_Status_Valid", "[Status] IN ('Active', 'Disabled')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_feedbacks_Priority_Valid", "[Priority] IN ('Low', 'Medium', 'High', 'Urgent')");
                    table.CheckConstraint("CK_feedbacks_Rating_Range", "[Rating] IS NULL OR [Rating] BETWEEN 1 AND 5");
                    table.CheckConstraint("CK_feedbacks_Status_Valid", "[Status] IN ('Submitted', 'Assigned', 'InProgress', 'Resolved', 'Closed', 'Cancelled')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_notifications_Type_Valid", "[Type] IN ('FeedbackSubmitted', 'FeedbackAssigned', 'FeedbackStatusChanged', 'FeedbackResponseAdded', 'FeedbackCommentAdded', 'FeedbackResolved', 'FeedbackRejected', 'FeedbackClosed', 'SystemAlert')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_feedback_status_history_FromStatus_Valid", "[FromStatus] IN ('Submitted', 'Assigned', 'InProgress', 'Resolved', 'Closed', 'Cancelled')");
                    table.CheckConstraint("CK_feedback_status_history_ToStatus_Valid", "[ToStatus] IN ('Submitted', 'Assigned', 'InProgress', 'Resolved', 'Closed', 'Cancelled')");
                    table.ForeignKey(
